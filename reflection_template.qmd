...
-   Example removing specified columns: **Lab 3 Question 5 - Revised/Edited**
...
-   Numeric Example 1 **Lab 5 Identify Suspects - Modified**
...
detective |> 
  mutate(
    potential_suspect = if_else(str_detect(membership_id,
                    pattern = "^48Z"),1,0)
  )
...
-   I can use non-standard colors (Example 2) - **Challenge 4 Plot of the Data** im strugglin
...
I think it is really important to lift people up for going the extra mile for creativity. I also makes me feel really good in a peer review when I know that I am simultaneously struggling, but there is advice to be given. It took me a long time to consistently have professional report skills, so I wanted to share that knowledge.

<!-- Include a description of how you grew as a collaborator through the weekly pair programming activities.   -->

It was really difficult to be the computer role during collaboration, because I want to blurt out the answer to the problem if I know it. However, I think that I learn best when challenged in the role of the coder, so I am trying my best to honor that experience. I think having mutual respect for the process with another partner has really garnered a positive space to grow. I think I am doing a better job at asking questions and helping others to find solutions on their own!
